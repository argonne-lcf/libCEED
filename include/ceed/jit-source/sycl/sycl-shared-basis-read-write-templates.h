...
inline void loadMatrix(SharedData_Sycl &data, const CeedScalar *restrict d_B, CeedScalar *restrict B) {
...
inline void ReadElementStrided1d(SharedData_Sycl, const CeedInt num_elem, const CeedInt strides_node,
                                 const CeedInt strides_comp, const CeedInt strides_elem, const CeedScalar *restrict d_u,
                                 CeedScalar *restrict r_u) {
  // const CeedInt item_id_x = get_local_id(0);
  // const CeedInt elem      = get_global_id(2);

  if (data.item_id_x < P_1D && data.group_id_z < num_elem) {
    const CeedInt node = data.item_id_x;
    const CeedInt ind  = node * strides_node + data.group_id_z * strides_elem;
...
inline void WriteElementStrided1d(SharedData_Sycl &data, const CeedInt num_elem, const CeedInt strides_node,
                                  const CeedInt strides_comp, const CeedInt strides_elem, const CeedScalar *restrict r_v,
...
inline void SumElementStrided1d(SharedData_Sycl &data, const CeedInt num_elem, const CeedInt strides_node,
                                  const CeedInt strides_comp, const CeedInt strides_elem, const CeedScalar *restrict r_v, CeedScalar *restrict d_v) {
  if (data.item_id_x < P_1D && data.group_id_z < num_elem) {
    const CeedInt node = data.item_id_x;
    const CeedInt ind  = node * strides_node + data.group_id_z * strides_elem;
...
inline void ReadElementStrided2d(SharedData_Sycl &data, const CeedInt num_elem, const CeedInt strides_node,
  ...
  if (data.item_id_x < P_1D && data.item_id_y < P_1D && data.group_id_z < num_elem) {
